...
class IndexLoader:
    ...
    def _load_codec(self):
        ...
        # [Modified] Pass use_gpu to ensure codec loads centroids to GPU if needed
        self.codec = ResidualCodec.load(self.index_path, is_build_index=False, use_gpu=self.use_gpu)
