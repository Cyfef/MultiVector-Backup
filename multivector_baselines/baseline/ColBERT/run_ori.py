...
def build_index_official(username: str, dataset: str, embedding_folder: str = None, input_query_embedding_file: str = None, gt_file:str=None, doc_count_file:str=None, datasets_with_embeddings:list = ["openai", "mscoco"], dataset_dim_mappings={"openai":768, "mscoco":768, "openai_gpt2_large": 1280}, query_embedding_len_file= None):
