...
def extract_gnd_mrr(username: str, dataset: str, query_offsetID_l: np.ndarray):
    ...
    for query_offsetID in query_offsetID_l:
        ...
        try:
            ...
            query_offset_2_gnd_m[query_offsetID] = gnd_json['answer_pids']
...
def generate_data_by_sample(username: str, origin_dataset: str, new_dataset: str,
    ...
    raw_data_base_path = f'/data/{username}/Dataset/multi-vector-retrieval/RawData'
    ...
    print("queries_gnd_json_l_filename:", queries_gnd_json_l_filename)
    print("queries_short_answer_gnd_json_l_filename:", queries_short_answer_gnd_json_l_filename)
...
def build_basic_index(username: str, origin_dataset: str, new_dataset: str, n_sample_item: int, n_sample_query: int,
                      topk_l: list):
    embedding_path = f'/data/{username}/Dataset/multi-vector-retrieval/Result/Embedding'
    os.system(f'rm -r {embedding_path}/{new_dataset}')

    index_path = f'/data/{username}/Dataset/multi-vector-retrieval/Result/Index'
    os.system(f'rm -r {index_path}/{new_dataset}')

    rawdata_path = f'/data/{username}/Dataset/multi-vector-retrieval/Result/RawData'
