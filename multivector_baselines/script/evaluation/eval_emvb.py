...
def approximate_solution_retrieval(username: str, dataset: str, topk: int, build_index_suffix: str,
    ...
    os.system(
        f'cd /data/{username}/multi-vector-retrieval/baseline/emvb/build && ./perf_emvb -topk {topk} -nprobe {nprobe} -thresh {thresh} '
    ...
    result_fname = f'/data/lijunlin/Dataset/multi-vector-retrieval/Result/answer/' \
                   f'{dataset}-emvb-top{topk}-{build_index_suffix}-{retrieval_suffix}.tsv'
    performance_fname = f'/data/lijunlin/Dataset/multi-vector-retrieval/Result/answer/' \
...
def approximate_solution_build_index(username: str, dataset: str,
    ...
    embedding_dir = f'/data/lijunlin/Dataset/multi-vector-retrieval/Embedding/{dataset}'
    ...
    result_performance_path = f'/data/lijunlin/Dataset/multi-vector-retrieval/Result/performance'
...
def approximate_solution_retrieval_outter(username: str, dataset: str,
    ...
    for retrieval_config in retrieval_parameter_l:
        ...
        result_answer_path = f'/data/lijunlin/Dataset/multi-vector-retrieval/Result/answer/'
        ...
        result_performance_path = f'/data/lijunlin/Dataset/multi-vector-retrieval/Result/single_query_performance'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', type=str, default='clip-multi-clustering') # 'openai_gte_small'
    ...
    config_l = {
        'dbg': {
            ...
            'retrieval_parameter_l': [
                ...
                {'nprobe': 4, 'thresh': 0.4, 'out_second_stage': 64, 'thresh_query': 0.5, 'n_doc_to_score': 400}
                # {'nprobe': 2, 'thresh': 0.4, 'out_second_stage': 10, 'thresh_query': 0.5, 'n_doc_to_score': 50},
            ],
            'grid_search': True,
            'grid_search_para': {
                10: {
        ...
        'local': {
            ...
            'retrieval_parameter_l': [
                {'nprobe': 4, 'thresh': 0.4, 'out_second_stage': 64, 'thresh_query': 0.5, 'n_doc_to_score': 50},
                # {'nprobe': 2, 'thresh': 0.4, 'out_second_stage': 64, 'thresh_query': 0.5, 'n_doc_to_score': 20},
                # {'nprobe': 2, 'thresh': 0.4, 'out_second_stage': 10, 'thresh_query': 0.5, 'n_doc_to_score': 100},
                # {'nprobe': 2, 'thresh': 0.4, 'out_second_stage': 32, 'thresh_query': 0.5, 'n_doc_to_score': 50},
            ...
            'grid_search_para': {
                ...
                #     'out_second_stage': [512, 2048],
                #     'thresh_query': [0.5],
                #     'n_doc_to_score': [100, 1000, 4000]
                # },
                # # 10: {
                #     'nprobe': [32],
                #     'thresh': [0.2],
                #     'out_second_stage': [100],
                #     'thresh_query': [0.5],
                #     'n_doc_to_score': [200]
                # },
                # 100: {
