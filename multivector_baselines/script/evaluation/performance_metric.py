    ...
    with open(gnd_jsonl_filename, 'r', encoding="utf-8") as f:
        for line in f:
            ...
            try:
                ...
                queryID = query_gnd_json['qid']
                passageID_l = query_gnd_json['answer_pids']
...
def load_groundtruth(username: str, dataset: str, topk: int):
    ...
    rawdata_path = f'/data/{username}/Dataset/multi-vector-retrieval/RawData/{dataset}'
...
def count_accuracy(username: str, dataset: str, topk: int,
    ...
    answer_dir = f'/data/{username}/Dataset/multi-vector-retrieval/Result/answer'
...
def count_accuracy_by_baseline_ip(username: str, dataset: str, topk_l: list,
    ...
    embedding_dir = f'/data/{username}/Dataset/multi-vector-retrieval/Embedding/{dataset}'
    answer_dir = f'/data/{username}/Dataset/multi-vector-retrieval/Result/answer'
    performance_dir = f'/data/{username}/Dataset/multi-vector-retrieval/Result/performance'
